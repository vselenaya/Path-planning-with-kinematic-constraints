...
int main() {
    ...
    */
    ...
    vector <string> cs = {"main_control_set", "short_control_set", "big_control_set"};  // control_set
    vector <string> types = {"main_types", "short_types", "big_types"};  // соответствующие типы
